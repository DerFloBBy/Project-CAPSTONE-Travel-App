...
app.listen(8081, function() {
    console.log('TESSST - Example app listening on port 8081!');
});
...
app.post('/apiRequest', perform);

// function getDataNew(req, res) {
//     console.log('hier bin ich #1');
...
async function perform(req, res) {
    ...
    await getCoordinates()
        ...
        .then(() => {
            console.log('hier bin ich #3');
        });
}
console.log('---ENDE---');
// }

function getCoordinates(projectData) {
    console.log('------FUNCTION TEST getCoordinates------');
}

function getWeather(projectData) {
    console.log('------FUNCTION TEST getWeather------');
}
